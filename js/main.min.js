		...
		<header class="header">
    			<div class="container">
     				 <div class="header__inner">
       				 <img class="header__photo" src="images/me.png" alt="My photo">
       				 <div class="header__content">
         			 <div class="header__content-top">
          			  <div class="header__personal-info">
             			 <div class="header__info-top">
                			<div class="header__info-text--box">
			                  <p class="header__info-text">Тернопільський національний технічний університет ім. Івана Пулюя</p>
			                  <p class="header__info-text">Факультет ФІС</p>
			                  <p class="header__info-text">Кафедра комп’ютерних наук</p>
				               				 </div>
				                <a class="header__logo--link" href="https://dl.tntu.edu.ua/users/index.php" target="_blank">
				                  <img src="images/tntu.png" alt="logo TNTY">
				                </a>
				                <a class="header__logo--link" href="https://tntu.edu.ua/?p=uk/structure/faculties/fis" target="_blank">
				                  <img src="images/fis.png" alt="logo FIS">
				                </a>
              				</div>
			              <div class="header__info-bottom">
			                <p class="header__info-text">Персональна сторінка</p>
			                <p class="header__info-text">Мартинів Олександр Сергійович</p>
			                <p class="header__info-text">група СП-32</p>
			              </div>
			            </div>
			            <a class="header__logo--link" href="https://tntu.edu.ua/?p=uk/structure/departments/kn" target="_blank">
			              <img src="images/kn.png" alt="logo KN">
			            </a>
			          </div>
			          <div class="header__content-bottom">
			            <a class="header__content-link" href="index.html">Головне меню</a>
			          </div>
			        </div>
			      </div>
			    </div>
    ...
    <div class="container">
      <div class="footer__inner">
        <div class="footer__socials">
          <a class="footer__socials-link" href="https://www.facebook.com/AlexanderMartyniv/" target="_blank">
          ...
          <a class="footer__socials-link" href="https://t.me/inertiared" target="_blank">
            <svg width="48" height="48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
